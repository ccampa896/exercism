module ResistorTrioDecoding
  ...
  begin # private constants
    ...
    REPORT = 'Resistor value: %<magnitude>i %<prefix>sohms'
...
if $PROGRAM_NAME == __FILE__
  ...
  puts "The current public template is: '#{ResistorTrioDecoding::REPORT}'"
  puts "It receives the :magnitude and :prefix keys dynamically."

  puts "\n--- Custom Output (Self-Service) ---"
  custom_template = "Magnitude: %<magnitude>i | Multiplier: %<prefix>s"
